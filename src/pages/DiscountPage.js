...
function DiscountPage(props)
{
    ...
    const bestProducts = useSelector((state)=>{
        return data.Products.filter(c=>c.Discount>0).sort((a, b) => (a.Discount > b.Discount) ? -1 : 1) ;//state.configReducer.popularProducts
    })
...
export default connect()(multilanguage(DiscountPage));